...
from planner import load_planner, add_session, view_day, view_week
...
while True:
    ...
    print("5. Add study plan")
    print("6. View a day's plan")
    print("7. View weekly plan")
    print("8. Exit")
    ...
    # Start study session
        ...
        try:
            ...
            minutes = int(
                input("How many minutes do you want to study? ")
            )
